            ...
            <div class="flex flex-col w-full md:w-5/12 bg-gray-100 rounded-lg mt-8">
                ...
                <div class="flex w-4/5 m-auto justify-between items-center mt-8 mb-4">
                    <div class="text-grey-darker hover:bg-gray-300 rounded-full p-1">
                        <svg @click="random = !random" :class="random ? 'text-blue-500' : ''"
                            class="w-8 h-8 cursor-pointer" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20">
                            <path
                    ...
                    <div class="text-grey-darker hover:bg-gray-300 rounded-full p-1">
                        <svg @click="repeat = !repeat" :class="repeat ? 'text-blue-500' : ''"
                            class="w-8 h-8 cursor-pointer" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20">
                            <path
                ...
                <ul class="w-full overflow-auto m-auto mb-2 bg-gray-100 pt-2" style="max-height: 100%"
                    ...
                    <li @click="selectSound(indexo)" :style="indexo == index ? '' : ''" :class="
                      indexo == index
                        ...
                        : ''
                    " class="flex py-1 rounded cursor-pointer w-11/12 m-auto" v-for="(audio, indexo) in audios"
                        :key="indexo">
